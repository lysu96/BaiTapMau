...
<body>
	...
	<?php 
		$item_per_eage = '';
		$danhsachsampham = array(
								array(
									'img'=>'aonam1.jpg',
									'name'=>'Áo phao gió chất đẹp',
									'des'=>'áo choàng băng giá làm ấm trái tim anh'),
							array(
									'img'=>'aonam1.jpg',
									'name'=>'Áo phao gió chất đẹp',
									'des'=>'áo choàng băng giá làm ấm trái tim anh'),
		...
		for ($i = 0; $i < count($danhsachsampham) ; $i++) {
		$ds = $danhsachsampham[$i];
	 ?>
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="<?php echo $ds['img']; ?>" alt="ao nam">
      <div class="caption">
        <h3><!-- <?php echo $ds['name']; ?> --></h3>
        <p><!-- <?php echo $ds['des']; ?> --></p>
        <p><a href="#" class="btn btn-primary" role="button">Mua ngay</a> <a href="#" class="btn btn-default" role="button">120000 VND</a></p>
      </div>
    </div>
  </div>
  </div>
  	...
  	<div class="container">
  		<div class="col-md-12">
  			<ul class="pagination">
  				...
  				<?php 
  					$tongsp = count($danhsachsampham);
					$tongtrang = count($danhsachsampham)/$item_per_eage;
					if ($tongsp % $item_per_eage !=0) {
